...
def main():
    ...
    # costruisce il percorso corretto del file .locs
    ...
    pos_array = np.array([ch_pos[ch][:3] for ch in ch_names])
    ...
    names, D_geo = geodesic_distance_matrix_from_ch_pos(ch_pos, channel_order=ch_names, radius=0.095)
